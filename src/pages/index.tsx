    ...
    >
      ...
      <div className="flex-1 relative overflow-auto min-h-screen md:col-span-2" ref={containerRef} onScroll={handleScroll}>
        <div className="w-full min-h-[200vh] absolute top-0 left-0 pb-96 mb-96">
          <img src="https://picsum.photos/2000/2000?random=1" className="w-full h-96 object-cover" alt="Background" />
          ...
          <img src="https://picsum.photos/1200/1200?random=2" className="w-full h-80 object-cover my-10" alt="Background" />
          <img src="https://picsum.photos/1400/1300?random=3" className="w-full h-72 object-cover my-10" alt="Background" />
          <img src="https://picsum.photos/1100/1200?random=4" className="w-full h-96 object-cover my-10 mb-96" alt="Background" />
        </div>
